...
export const Home = () => {
    return (
        <>
            ...
            <div>
            <p id= 'textoprincipal'>Bienvenid@s a la Enciclopedia Galáctica! En esta página podrá encontrar la información más precisa y variada sobre diferentes tópicos que conciernen a nuestra galaxia.
